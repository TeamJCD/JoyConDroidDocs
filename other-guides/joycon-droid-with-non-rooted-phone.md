...
1\) On the rooted Android, follow the [Bluetooth++ guide](../guides/bluetoothpp.md) (old) or [Joy-Con Droid Companion guide](joy-con-droid-companion.md) to change the Device Class to 002508.
